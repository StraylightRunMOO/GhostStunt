...
typedef void *(*malloc_fn) (size_t, bool);
typedef void *(*realloc_fn) (void*, size_t, bool);
typedef void (*free_fn) (void*, bool);
...
struct hashmap *hashmap_new_with_allocator(malloc_fn malloc, 
    realloc_fn realloc, free_fn free, size_t elsize, 
